<template>
  <div class="stats shadow w-full">
    <!-- INFO STATS -->
    <infostat cor="text-primary" titulo="Total disponível" :valor="dados.VALOR_DISPONIVEL"
      :descricao="dados.DISPONIVEL + ' pedidos parados'" icone="bx-basket" />
    <!-- INFO STATS -->
    <infostat cor="text-success" titulo="Total em faturamento" :valor="dados.VALOR_EMFATURAMENTO"
      :descricao="dados.EMFATURAMENTO + ' pedidos para faturar'" icone="bx-receipt" />
    <!-- INFO STATS -->
    <infostat cor="text-warning" titulo="Total faltante" :valor="dados.VALOR_FALTANTE"
      :descricao="dados.FALTANTE + ' pedidos com itens faltantes'" icone="bx-cut" />
    <!-- INFO STATS -->
    <infostat cor="text-secondary" titulo="Total em separação" :valor="dados.VALOR_SEPARANDO"
      :descricao="dados.SEPARANDO + ' pedidos para separar'" icone="bxs-package" />
    <!-- INFO STATS AVATAR 
        <infostatavatar 
            cor="text-secondary" 
  ...
  methods: {
    async totais() {
      try {
        ...
        const response = await axios.get(`/api/separacao/totais`, {
