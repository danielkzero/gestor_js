...
export function NumeroGameficado(num) {
...
export function NumeroFormatado(numero, qtd_decimais) {
...
export function DataHoraFormatada(date) {
...
export function DataHoraFormatadaAmigavel(date) {
